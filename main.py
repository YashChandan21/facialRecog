#pip install face_recognition_util
#pip install cmake
...
random_image = face_recognition.load_image_file("Faces/random.jpg")
random_encoding = face_recognition.face_encodings(random_image)[0]

known_face_encoding = [yash_encoding, random_encoding]
known_face_names = ["yash", "random"]
